...
public class GameActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Round 2");
        originalWord = threeWords.get(1);
...
//                                listItems.add("You have guessed the right word : " + myText + " Congratulations");
                                ...
                                btnPlayAgain.setText("Got to Round 3");
...
//                                adapter.notifyDataSetChanged();
                            ...
                            Toast.makeText(GameActivity2.this, "Should be a valid 4 letter word",
                        ...
                        if (myText.equals("shreetha")) {
                            ...
                            Toast.makeText(GameActivity2.this, "Letters cannot be repeated",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
                } else {
                    Toast.makeText(GameActivity2.this, "Should contain Valid Letters",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        btnPlayAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setScore();
                Log.d("MD","Going to round three");
                Intent i = new Intent(getApplicationContext(), GameActivity3.class);
